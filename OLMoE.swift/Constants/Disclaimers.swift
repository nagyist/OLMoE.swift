...
struct Disclaimers {
    ...
    struct FullDisclaimer: Disclaimer {
        ...
        let headerTextContent = [
            ...
            HeaderTextPair(
                ...
                text: """
                OLMoE runs locally on your device and Ai2 will not collect your interactions with the app. OLMoE only stores your most recent conversation and you can manually delete each conversation by starting a new thread. Ai2 will receive anonymized app development data though Apple's crash analytics APIs in accordance with our [Privacy Policy](https://allenai.org/privacy-policy). Please use your discretion and best judgment when sharing any personal, sensitive, or confidential information in your use of the OLMoE app.
                """),
            HeaderTextPair(
                header: "Acceptance",
                text: """
    ...
    struct ShareDisclaimer: Disclaimer {
        ...
        let text = """
            ...
            Once you select “Share” below, your conversation and related interaction data will be retained by Ai2 as described in our [Terms of Use](https://allenai.org/terms) and [Privacy Policy](https://allenai.org/privacy-policy). By sharing, you agree to allow Ai2 to collect this interaction data for scientific research and educational purposes and to develop or improve this app as well as  the models and underlying technology presented in this app. If you do not want to share your interaction data with Ai2, please press “Cancel” to cancel sharing.
            """
